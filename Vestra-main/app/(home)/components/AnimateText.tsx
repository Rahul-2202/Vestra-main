...
//           textTimeoutId = setTimeout(() => animateIn(index + 1), 250); // Typing speed
//         } else {
//           textTimeoutId = setTimeout(animateOut, 1000); // Pause before animating out
//         }
//       };
...
//           if (index >= 0) {
//             setDisplayText(text.slice(0, index));
//             textTimeoutId = setTimeout(() => outAnimation(index - 1), 150); // Deleting speed
//           } else {
//             textTimeoutId = setTimeout(() => setDisplayText(""), 500); // Pause before starting the next word
//           }
//         };
//         outAnimation(text.length);
//       };
...
//   useEffect(() => {
//     const wordDuration = currentWord.length * 250 + 1000; // Time to animate in, pause, and animate out
//     const timeoutId = setTimeout(() => {
//       setCurrentWordIndex((prevIndex) => (prevIndex + 1) % words.length);
//     }, wordDuration);
...
//     <div className="flex items-center justify-center">
//       <div
//         className="ml-1 text-4xl md:text-6xl lg:text-6xl font-medium font-ttfir text-center flex text-[#E52D27]"
//         aria-live="polite"
//         aria-atomic="true"
//       >
//         <span className="transition-opacity duration-500 ease-in-out">
